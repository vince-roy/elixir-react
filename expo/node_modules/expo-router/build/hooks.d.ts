...
export declare function useRootNavigationState(): import("expo-router/build/fork/getStateFromPath").ResultState;
export declare function useRouteInfo(): import("expo-router/build/LocationProvider").UrlObject;
